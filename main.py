...
# 8. Pink + black UI
# 9. No transformers pipeline dependency
# 10. Compatible with newer Transformers versions
# ============================================================
...
def build_highlighted_document(
    ...
    # --------------------------------------------------------
    # Determine number of highlighted sentences
    # --------------------------------------------------------
...
with st.spinner(
    ...
    tokenizer, summarization_model = load_model(
        model_choice
    )
...
<div class="custom-footer">
    © The copyrights of this work is to the owner
</div>
""",
    unsafe_allow_html=True
)
